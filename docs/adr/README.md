...
| [0036](0036-multi-agent-adapters.md) | Registry de adapters multi-agente (`copilot-cli` default; env `AGENT_ADAPTER`; `GET /agents/adapters`; `available` booleano derivado de presença de env/CLI, sem vazar segredo; `AgentRunner` inalterado) | Aceito |
